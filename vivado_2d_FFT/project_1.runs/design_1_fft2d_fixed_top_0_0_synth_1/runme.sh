...
HD_PWD='D:/vivado_2d_FFT/project_1.runs/design_1_fft2d_fixed_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fft2d_fixed_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fft2d_fixed_top_0_0.tcl
